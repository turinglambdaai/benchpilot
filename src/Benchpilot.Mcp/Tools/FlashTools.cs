...
internal sealed class FlashTools
{
    ...
    [McpServerTool]
    [Description("Flash firmware to a target using its configured flash capability. Profiles may require confirmTarget to exactly match the semantic target id.")]
